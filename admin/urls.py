...
urlpatterns = [
    ...
    url(r'^busniss_data$', 'visualization.views.busniss_data', name='busniss_data'),
    ...
    url(r'^api/post_get_order_countAndmoney_data$', 'visualization.views.api_post_get_order_countAndmoney_data', name='api_post_get_order_countAndmoney_data'),
    url(r'^api/post_get_site_DAUPV_data$', 'visualization.views.api_post_get_site_DAUPV_data', name='api_post_get_site_DAUPV_data'),
    ...
    url(r'^api/post_delete_pic_profile$', 'customization.views.post_delete_pic_profile', name='post_delete_pic_profile'),
    url(r'^api/post_conf_dashboard$', 'customization.views.post_conf_dashboard', name='post_conf_dashboard'),
]
